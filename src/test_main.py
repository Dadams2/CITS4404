...
print("worm_internal: \t\t", internal_cost_score(100, worm_internal, img_shape))
...
print("worm_internal_1: \t", internal_cost_score(100, worm_internal_1, img_shape))
...
print("worm_internal_2: \t", internal_cost_score(100, worm_internal_2, img_shape))
...
print("worm_internal_3: \t", internal_cost_score(100, worm_internal_3, img_shape))
